...
% Zdesired=1.4+.30*sin(.2*pi*tt)+.06*sin(.4*pi*tt)+.01*sin(.7*pi*tt)+.01*sin(pi*tt);


%Testday
% Zdesired=1.4+.30*sin(.2*pi*tt)+.06*sin(.4*pi*tt)+.01*sin(.6*pi*tt)+.01*sin(.8*pi*tt)+.01*sin(1*pi*tt);
%Test
Zdesired=1.4+.30*sin(.1*pi*tt)+.06*sin(.3*pi*tt)+.01*sin(.5*pi*tt)+.01*sin(.7*pi*tt)+.01*sin(.9*pi*tt);


xyDesired(1:2,1) = [goalDesired(1,GoalPt);goalDesired(1,GoalPt)];



vertDesired = Zdesired;  
