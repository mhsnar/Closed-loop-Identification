...
Training='Testing_CT_TestDay_X.mat';
...
OutputVector_X=Training_output_data_new(1:3,:);

u_x=Training_input_data_new(1,:);

%%
u = u_x;
xdot =OutputVector_X(2,:); % Your xdot data here;
xddot = OutputVector_X(3,:);% Your xddot data here;
