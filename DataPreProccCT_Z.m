...
Training='Testing_CT_TestDay_Z.mat';
...
OutputVector_Z=Training_output_data_new(7:9,:);

u_z=Training_input_data_new(3,:);
%%
u = u_z;
xdot =OutputVector_Z(2,:); % Your xdot data here;
xddot = OutputVector_Z(3,:);% Your xddot data here;
